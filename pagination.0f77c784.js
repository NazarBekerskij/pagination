...
let totalPage = 0;
function getNews() {
    return fetch(`https://gnews.io/api/v4/search?q=tesla&lang=en&max=${pageSize}&page=${page}&apikey=9a420d5dc04e57775b18d56d070814d6`).then((res)=>res.json());
}
getNews().then((res)=>{
...
function createArticles(array) {
    ...
    const item = array.map(({ title, description, publishedAt, image, source })=>{
        const imageUrl = image ? image : "https://hostiq.ua/wiki/wp-content/uploads/2021/05/03-error-404-not-found.png";
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire940f", {})

//# sourceMappingURL=pagination.0f77c784.js.map
