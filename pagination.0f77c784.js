...
// }
function getNews() {
    return fetch(`https://newsapi.org/v2/everything?q=tesla&sortBy=publishedAt&apiKey=dfe64df20e5048dc81abc33421bdfb23&pageSize=${pageSize}&page=${page}`).then((res)=>res.json());
}
getNews().then((res)=>{
...
newsObserver.observe(document.querySelector(".box")) // function createNewsItems(array){
